...
[Tooltip("Fuerza con la que el enemigo es empujado al recibir daño.")]
...
[SerializeField] private float stunDuration = 0.5f;
       private void InitializeStates()
        {
            playerTransform = FindFirstObjectByType<BasicMovement>().transform;
        ...
        /*public void MoveTowards(Vector2 destination, float speedMultiplier = 1)
        {
            ...
            transform.position += direction.normalized * enemyMoveSpeed * Time.deltaTime * speedMultiplier;
        }
*/public void MoveTowards(Vector2 destination, float speedMultiplier = 1)
{
    if (isStunned) return;
